...
- (void)mouseEnteredInCell:(NSInteger)rowIndex {
    if (self.delegate && [self.delegate respondsToSelector:@selector(listView: mouseOverCell:)]) {
        [self.delegate listView:self mouseOverCell:rowIndex];
    }
}
